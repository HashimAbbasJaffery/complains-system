                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination">
                                            <Link :href="link.url" :style="{ 'background-color': '#f5f5f5'}" class="page-item" v-for="link in complains.links" :key="link.label"><a class="page-link" :style="{ 'background-color': link.active ? '#f5f5f5' : '' }" href="#" v-html="link.label"></a></Link>
                                        </ul>
                                    </nav>
                                </div>
                            </div>
